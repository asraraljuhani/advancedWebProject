    ...
    <div class="container d-flex align-items-center justify-content-between" >
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="userhome.php#services">Services</a></li>
          <li><a class="nav-link scrollto" href="userhome.php#blogs">Blogs</a></li>
          <li><a class="nav-link scrollto" href="userOrders.php">My Order</a></li>
